...
class LidarOdomNode:
    ...
    def lidar_callback(self, data):
        if self.odom_data is not None:
            ...
            print('Left Mapped points are: ', self.left_mapped)
            print('Right Mapped points are: ', self.right_mapped)
            ...
            self.marker_array(self.left_world_points, (0.0,0.0,1.0,1.0))
            self.marker_array(self.right_world_points,(1.0,1.0,0.0,1.0))
            marker_publisher.publish(markerArray)
            markerArray.markers.clear()
            ...
            self.right_world_points = [point for point in self.right_world_points if euclidean_sort(point,odom_data) >= 1.0]
